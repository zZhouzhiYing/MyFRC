...
class ResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        # x = self.layer2(x)
        # x = self.layer3(x)
        # print('l3',x.shape)#16,1024,14,14
...
class F1(ResNet,nn.Module):
    ...
    def forward(self, x):
        ...
        x = self.layer2(x)
        x = self.layer3(x)
        print('l3',x.shape)#16,1024,38,38
        return x

class F2(ResNet,nn.Module):
    def __init__(self,block,layers):
    ...
    def forward(self, x):
        ...
        x = self.avgpool(x)
        print('heihei',x.shape)#([16, 2048, 2, 2])
        # x = x.view(x.size(0), -1)
        # x = self.fc(x)
        return x
